...
METRICS = (
    ...
    ("tempco_ppm_per_c", "Tempco", "lower"),
    ("vref_temp_nonlinearity_v", "Vref Temp Nonlinearity", "lower"),
    ("psrr_db", "PSRR", "higher"),
    ("line_regulation_v_per_v", "Line Regulation", "lower"),
    ("startup_time_s", "Startup Time", "lower"),
