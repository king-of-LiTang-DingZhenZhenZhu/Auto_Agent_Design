...
def prepare_virtuoso_workspace(
    ...
    cds_lib.write_text(_render_cds_lib(lib_name), encoding="utf-8")
...
def _render_cds_lib(lib_name: str) -> str:
    return "\n".join([
        "-- Auto-generated by Circuit Agent Virtuoso exporter",
        "-- Ensure your Cadence environment can also resolve PDK libraries",
        "-- such as tsmcN28 and analogLib through site cds.lib setup.",
